          ...
          {KYARI_FEATURES.map((feature, index) => (
            ...
            >
              ...
              <div className="space-y-1.5 px-1">
                <h3 className="font-quicksand text-[15px] font-bold leading-tight text-[#1D4D44] lg:text-lg">
                ...
                <p className="font-quicksand text-[12px] leading-relaxed text-[#1D4D44]/70 lg:text-sm">
                  {feature.description}
                </p>
              </div>
            </div>
