    ...
    <section className="bg-white py-12 lg:py-16">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 lg:gap-10">
          {KYARI_FEATURES.map((feature, index) => (
            <div 
              key={index} 
              className="group flex flex-col items-center text-center"
            >
              <div className="relative mb-6 flex h-[140px] w-full items-center justify-center overflow-hidden rounded-[5px] bg-[#F9F9F9] transition-transform duration-500 group-hover:scale-[1.02]">
                <img
                  src={feature.image}
                  alt={feature.title}
              ...
              <div className="space-y-2">
                <h3 className="font-quicksand text-lg font-bold text-[#1D4D44]">
                ...
                <p className="font-quicksand text-sm text-[#1D4D44]/70 leading-relaxed">
                  {feature.description}
                </p>
              </div>
            </div>
