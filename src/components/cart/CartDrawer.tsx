  ...
  return (
    ...
    >
      ...
      <aside className={cn(
        ...
        <header className="grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-4 border-b border-border px-2.5 py-1.5">
        ...
        <div className="flex-1 overflow-y-auto px-2.5 pt-5 pb-1">
        ...
        <footer className={cn("border-t border-border p-2.5", lines.length === 0 && "hidden")}>
