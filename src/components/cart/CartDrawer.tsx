            ...
            <div className="flex flex-col items-center py-4">
              {isLoading ? (
                ...
                <div className="w-full space-y-8">
                  ...
                  <div className="flex items-center justify-center gap-2 rounded-[5px] bg-[#1D4D44] py-3 text-[12px] text-white">
                  ...
                  <button
                    onClick={closeCart}
                    className="w-full rounded-full bg-[#1D4D44] py-4 text-sm text-white transition-all hover:shadow-md uppercase tracking-wider"
                  >
                    Return to Shop
                  </button>
                </div>
        ...
        <footer className={cn("border-t border-border p-4", lines.length === 0 && "hidden")}>
          ...
          <div className="mt-4 flex flex-col gap-2">
            <button
              ...
              className="relative flex h-[44px] w-full items-center justify-center rounded-full bg-[#1D4D44] px-8 text-sm font-normal text-white transition-all duration-300 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
            >
