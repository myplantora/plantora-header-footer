  ...
  return (
    ...
    >
      ...
      {product.tags?.includes("Combo") && (
        <div className="flex h-[32px] md:h-[38px] items-center justify-start gap-1.5 bg-[#8CD4DC] px-2.5 rounded-b-[15px] md:rounded-b-[20px] -mx-px">
          <img 
      ...
      <div className="flex flex-1 flex-col pt-3 pb-2">
        ...
        <h3 className="line-clamp-2 text-[14px] md:text-[16px] font-bold leading-[1.3] text-[#254838] font-quicksand mb-2 min-h-[2.6em] flex items-start">
          {product.title}
        </h3>
