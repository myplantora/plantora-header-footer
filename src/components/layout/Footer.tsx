      ...
      <ul className="mt-5 space-y-3">
        {links.map((link) => (
          <li key={link.label}>
            <Link
              to={link.href}
              className="footer-link text-[15px] text-white/75 transition-colors duration-300 hover:text-white"
            >
              {link.label}
            </Link>
          </li>
...
export function Footer() {
  return (
    <footer style={{ backgroundColor: '#1D4D44' }} className="w-full text-white">
      <div className="mx-auto max-w-[1400px] px-[5px] py-10 sm:px-[5px] lg:px-[5px] lg:py-16">
      ...
      <div className="border-t border-white/15">
        <div className="mx-auto flex max-w-[1400px] flex-col items-center gap-4 px-[5px] py-4 text-[13px] text-white/70 sm:px-[5px] lg:flex-row lg:justify-between lg:px-[5px]">
