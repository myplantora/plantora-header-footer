...
export const Route = createFileRoute('/terms')({
  ...
  head: () => ({
    meta: [
      { title: 'Terms & Conditions | Plantora' },
      {
        name: 'description',
        content:
          'Read Plantora’s Terms & Conditions to understand the rules and guidelines for using our website and services.',
      },
      { property: 'og:title', content: 'Terms & Conditions | Plantora' },
      {
    ...
    <main className="mx-auto max-w-[1400px] px-2.5 py-10 font-sans text-[#1D4D44] md:py-16 lg:px-5">
      <article className="mx-auto max-w-3xl">
        ...
        <PolicySection title="OVERVIEW">
          <p>
            This website is operated by myplantora.com. Throughout the site, the
            terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo; refer
            to myplantora.com. myplantora.com offers this website, including all
          ...
          <p>
            ...
            terms and conditions (&ldquo;Terms of Service&rdquo;, &ldquo;Terms&rdquo;),
        ...
        <PolicySection title="SECTION 1 - ONLINE STORE TERMS">
        ...
        <PolicySection title="SECTION 2 - GENERAL CONDITIONS">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION">
          <p>
        ...
        <PolicySection title="SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES">
          <ul className="list-disc space-y-2 pl-5">
        ...
        <PolicySection title="SECTION 5 - PRODUCTS OR SERVICES">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION">
          <p>
        ...
        <PolicySection title="SECTION 7 - OPTIONAL TOOLS">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 8 - THIRD-PARTY LINKS">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS">
          <p>
        ...
        <PolicySection title="SECTION 10 - PERSONAL INFORMATION">
          <p>
        ...
        <PolicySection title="SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS">
          <p>
        ...
        <PolicySection title="SECTION 12 - PROHIBITED USES">
          <p>
        ...
        <PolicySection title="SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY">
          <ul className="list-disc space-y-2 pl-5">
            <li>
            ...
            <li>
              In no case shall myplantora.com, our directors, officers,
        ...
        <PolicySection title="SECTION 14 - INDEMNIFICATION">
          <p>
            You agree to indemnify, defend and hold harmless myplantora.com and
        ...
        <PolicySection title="SECTION 15 - SEVERABILITY">
          <p>
        ...
        <PolicySection title="SECTION 16 - TERMINATION">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 17 - ENTIRE AGREEMENT">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 18 - GOVERNING LAW">
          <p>
        ...
        <PolicySection title="SECTION 19 - CHANGES TO TERMS OF SERVICE">
          <ul className="list-disc space-y-2 pl-5">
            <li>
        ...
        <PolicySection title="SECTION 20 - CONTACT INFORMATION">
          <p>Questions about the Terms of Service should be sent to us at:</p>
          <address className="mt-4 not-italic text-sm leading-relaxed md:text-base">
            <p className="font-medium">Address:</p>
            <p>11902 Wilcrest Dr Houston, TX 77031</p>
            <p className="mt-2 font-medium">Call:</p>
            <p>
              <a
                href="tel:+12818009057"
                className="underline underline-offset-2 transition-opacity hover:opacity-70"
              >
                +1 (281) 800-9057
              </a>
